...
namespace Task_1
{
    ...
    public static class Hint
    {
        ...
        public static string HintView_v01()
        {
            var sb = new StringBuilder();
            
            foreach (var s in hint)
            {
                int result = 0;
                int n = 0;
        ...
        public static string HintView_v02_Horner()
        {
            //HORNER
            var radix = 6;
            var sb = new StringBuilder();
            ...
            {
                var result = int.Parse(h[0].ToString());
                for (int i = 1; i < h.Length; i++)
                {
                    result = (result * radix) + int.Parse(h[i].ToString());
                }
                sb.Append((char)result);
            }
            return sb.ToString();
